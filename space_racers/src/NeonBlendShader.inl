...
void main()
{
    gl_FragColor.rgb = blend(texture2D(u_sceneTexture, gl_TexCoord[0].xy).rgb, texture2D(u_neonTexture, gl_TexCoord[0].xy).rgb);
    gl_FragColor.a = 1.0;

    //gl_FragColor = texture2D(u_neonTexture, gl_TexCoord[0].xy);
})";