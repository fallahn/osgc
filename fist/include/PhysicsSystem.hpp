...
public:
    ...
    */
    ...
    /*
    \brief Applies the given force to the body in local coordinates
    */
    void applyForceAtLocalPoint(sf::Vector2f force, sf::Vector2f pos = {});

    /*!
    \brief Applies the given impulse in local coordinates (relative to object position)
    */
    void applyImpulseAtLocalPoint(sf::Vector2f force, sf::Vector2f pos = {});

    /*!
    \brief Sets the linear velocity at the centre of gravity. Should only be used
    on kinematic bodies.
    */
